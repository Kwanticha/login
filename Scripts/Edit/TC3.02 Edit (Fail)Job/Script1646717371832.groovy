...
WebUI.setText(findTestObject('Object Repository/Page_Register/input__job'), '')

WebUI.click(findTestObject('Object Repository/Page_Register/button_Edit Profile'))

WebUI.verifyTextPresent('อาชีพ', false)
WebUI.takeScreenshot('C:\\Users\\ASUS\\Downloads\\TC302.png')
