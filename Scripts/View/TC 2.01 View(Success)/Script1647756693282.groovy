...
WebUI.click(findTestObject('Object Repository/Page_Registration System/p_'))
...
WebUI.click(findTestObject('Object Repository/Page_Registration System/a__navbarDropdown'))

WebUI.click(findTestObject('Object Repository/Page_Registration System/a_My profile'))

WebUI.verifyTextPresent('ข้อมูลการศึกษา', false)

WebUI.click(findTestObject('Object Repository/Page_Profile/i__fas fa-user'))
